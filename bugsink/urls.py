...
from issues.api_views import IssueCommentViewSet, IssueExternalIssueViewSet, IssueViewSet
...
api_router.register(r'issue-external-issues', IssueExternalIssueViewSet, basename='issue-external-issue')
